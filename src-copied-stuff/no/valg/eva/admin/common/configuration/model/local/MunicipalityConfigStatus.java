...
public class MunicipalityConfigStatus extends VersionedObject {
	@Getter
    private final AreaPath municipalityPath;
	@Getter
	...
	@Getter
    @Setter
    private boolean useElectronicMarkoffs;

	// Status fields
	@Getter
    @Setter
    private boolean advancePollingPlaces;
	@Getter
    @Setter
    private boolean electionPollingPlaces;
	@Getter
    @Setter
    private boolean electionCard;
	@Getter
    @Setter
    private boolean pollingDistricts;
	@Getter
    @Setter
    private boolean techPollingDistricts;
	@Getter
    @Setter
    private boolean reportingUnitStemmestyre;
	@Getter
    @Setter
    private boolean reportingUnitValgstyre;
	@Getter
    @Setter
    private boolean pollingStations;
	@Getter
    @Setter
    private boolean language;
	@Getter
    @Setter
    private boolean countCategories;
	@Getter
    @Setter
    private boolean listProposals;
	@Getter
    @Setter
