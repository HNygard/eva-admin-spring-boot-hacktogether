...
public class ElectionGroup extends VersionedObject {
	...
	@Getter
    private final ElectionPath parentElectionPath;
	@Getter
    @Setter
    private String electionEventName;
	@Getter
    @Setter
    private ElectionRef electionGroupRef;
	@Getter
    @Setter
    private String id;
	@Getter
	...
	@Getter
    @Setter
    private boolean scanningPermitted;
	@Getter
    @Setter
    private boolean validateRoleAndListProposal;
	@Getter
    @Setter
    private boolean validatePollingPlaceElectoralBoardAndListProposal;
